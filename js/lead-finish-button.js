...
;(function () {
	 ...
	 *
	 * ⚠ Формулировки НЕЙТРАЛЬНЫЕ и намеренно — не переписывай их в сторону
	 * конкретики. Экран видит рядовой менеджер, который к настройке отношения не
	 * имеет: доработка не вмешивается в отношения внутри компании клиента и
	 * говорит только о формальности между организациями.
	 *
